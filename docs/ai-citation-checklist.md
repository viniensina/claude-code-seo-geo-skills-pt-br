...
- [ ] Cada estatística tem fonte identificável.
- [ ] Fontes primárias aparecem antes de blogs agregadores.
- [ ] Dados antigos têm contexto ou foram substituídos.
- [ ] A metodologia explica mês/ano da coleta.
...
- [ ] Entidades importantes aparecem com nomes completos.
- [ ] O artigo explica termos antes de usar siglas.
...
- [ ] O artigo tem um trecho que outro autor poderia citar em uma frase.
- [ ] O bloco "Como citar" inclui nome do site, título e ano.
- [ ] A página deixa claro quem fez a curadoria.
- [ ] O conteúdo tem um ângulo que não é apenas "mais um guia".
- [ ] Existe pelo menos uma tabela ou lista que economiza tempo do leitor.
- [ ] O título comunica utilidade específica.

## QA antes de publicar

- [ ] Nenhum link interno está quebrado.
- [ ] Nenhum link externo aponta para página errada ou paywall inesperado.
- [ ] O artigo não contém Markdown cru no HTML final.
